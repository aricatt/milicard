...
const RESOURCES: Resource[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'categoryName', label: '品类名称', type: 'string' },
      { key: 'categoryCode', label: '品类编号', type: 'string' },
      { key: 'categoryNameI18n', label: '品类多语言名称', type: 'object' },
      { key: 'baseId', label: '基地ID', type: 'number' },
      { key: 'locationId', label: '位置ID', type: 'number' },
      { key: 'locationName', label: '位置名称', type: 'string' },
      { key: 'handlerId', label: '经手人ID', type: 'string' },
      { key: 'handlerName', label: '经手人', type: 'string' },
      { key: 'boxQuantity', label: '消耗箱数', type: 'number' },
      { key: 'packQuantity', label: '消耗盒数', type: 'number' },
      { key: 'pieceQuantity', label: '消耗包数', type: 'number' },
      ...
      { key: 'unitPricePerBox', label: '单价/包', type: 'number' },
      { key: 'packPerBox', label: '箱规(盒/箱)', type: 'number' },
      { key: 'piecePerPack', label: '盒规(包/盒)', type: 'number' },
      { key: 'calculatedCostPrice', label: '消耗金额', type: 'number' },
      { key: 'notes', label: '备注', type: 'string' },
      { key: 'createdBy', label: '创建人', type: 'string' },
      { key: 'updatedBy', label: '更新人', type: 'string' },
      { key: 'createdAt', label: '创建时间', type: 'date' },
  ...
  },
  {
    ...
    fields: [
      { key: 'id', label: 'ID', type: 'string' },
      { key: 'profitDate', label: '日期', type: 'date' },
      { key: 'baseId', label: '基地ID', type: 'number' },
      { key: 'locationId', label: '直播间ID', type: 'number' },
      { key: 'locationName', label: '直播间', type: 'string' },
      { key: 'handlerId', label: '主播ID', type: 'string' },
      { key: 'handlerName', label: '主播', type: 'string' },
      { key: 'gmvAmount', label: '大屏GMV', type: 'number' },
      { key: 'refundAmount', label: '退款金额', type: 'number' },
      { key: 'cancelOrderAmount', label: '取消订单', type: 'number' },
      { key: 'shopOrderAmount', label: '店铺订单', type: 'number' },
      { key: 'waterAmount', label: '走水金额', type: 'number' },
      { key: 'salesAmount', label: '真实GMV', type: 'number' },
      { key: 'calculatedCostPrice', label: '消耗金额', type: 'number' },
      { key: 'platformFeeAmount', label: '平台扣点', type: 'number' },
      { key: 'profitAmount', label: '毛利', type: 'number' },
      { key: 'profitRate', label: '毛利率', type: 'number' },
      { key: 'consumptionId', label: '消耗记录ID', type: 'string' },
      { key: 'consumption', label: '消耗记录', type: 'object' },
      { key: 'notes', label: '备注', type: 'string' },
      { key: 'createdBy', label: '创建人', type: 'string' },
      { key: 'createdAt', label: '创建时间', type: 'date' },
      { key: 'updatedAt', label: '更新时间', type: 'date' },
