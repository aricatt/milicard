...
const RESOURCES: Resource[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'cancelOrderAmount', label: '取消订单金额', type: 'number' },
      { key: 'shopOrderAmount', label: '店铺订单金额', type: 'number' },
      { key: 'offlineAmount', label: '走水金额', type: 'number' },
      { key: 'consumptionValue', label: '拿货价', type: 'number' },
      { key: 'adCost', label: '投流金额', type: 'number' },
      { key: 'platformFeeRate', label: '平台费率', type: 'number' },
      { key: 'platformFee', label: '平台扣点', type: 'number' },
      { key: 'dailySales', label: '真实GMV', type: 'number' },
