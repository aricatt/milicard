          ...
          <Alert
            ...
            description={
              <div>
                ...
                <p>3. <strong>商品名称</strong>需与系统中商品名称完全匹配</p>
                <p>4. <strong>供应商</strong>需与系统中供应商名称完全匹配（请先在"供应商"页面添加）</p>
                <p>5. 采购编号留空则自动生成，填写已存在的编号则会更新该订单</p>
                <p>6. 零售价、折扣、应付金额等字段由系统自动计算，导入时会被忽略</p>
                <p>7. 支持批量导入，建议每次不超过500条</p>
              </div>
            }
            type="info"
            showIcon
