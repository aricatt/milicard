export default {
  ...
  'pages.common.export': '導出',
  'pages.common.import': '導入',
  'pages.common.downloadTemplate': '下載模板',
  'pages.common.add': '添加',
  'pages.common.confirm': '確認',
  'pages.common.operation': '操作',
  'pages.common.status': '狀態',
  'pages.common.createTime': '創建時間',
  'pages.common.updateTime': '更新時間',
  'pages.common.remark': '備註',
  'pages.common.enabled': '啟用',
  'pages.common.disabled': '禁用',
  'pages.common.yes': '是',
  'pages.common.no': '否',
  'pages.common.loading': '加載中...',
  'pages.common.noData': '暫無數據',
  'pages.common.total': '共',
  'pages.common.items': '條',
};
